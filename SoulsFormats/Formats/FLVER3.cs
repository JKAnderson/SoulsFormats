...
namespace SoulsFormats
{
    ...
    /// </summary>
    public class FLVER3 : SoulsFile<FLVER3>
    {
        /// <summary>
        /// General values for this model.
        /// </summary>
        public FLVER3Header Header;
        ...
        /// <summary>
        /// Creates an uninitialized FLVER3. Should not be called publicly; use FLVER3.Read instead.
        /// </summary>
        public FLVER3() { }

        /// <summary>
        /// Returns true if the data appears to be a FLVER3.
        /// </summary>
        internal override bool Is(BinaryReaderEx br)
        {
            string magic = br.GetASCII(0, 6);
            return magic == "FLVER3\0";
        }

        /// <summary>
        /// Reads FLVER3 data from a BinaryReaderEx.
        /// </summary>
        internal override void Read(BinaryReaderEx br)
        {
            br.BigEndian = false;

            Header = new FLVER3Header();
            ...
            br.AssertInt32(0);
            br.AssertInt32(0);
            Header.UnkI3 = br.AssertInt32(0, 1, 2, 4);
            br.AssertInt32(0);
            br.AssertInt32(0);
            br.AssertInt32(0);
            br.AssertInt32(0);
        ...
        /// <summary>
        /// Writes FLVER3 data to a BinaryWriterEx.
        /// </summary>
        ...
        /// <summary>
        /// General metadata about a FLVER3.
        /// </summary>
        public class FLVER3Header
        {
            /// <summary>
            /// If true FLVER3 will be written big-endian, if false little-endian.
            /// </summary>
        ...
        public class Material
        {
            ...
            internal void WriteUnk(BinaryWriterEx bw, int index)
            {
                if (UnkBytes == null)
                {
        ...
        public class Bone
        {
            ...
            /// <summary>
            /// Index of the parent in this FLVER3's bone collection, or -1 for none.
            /// </summary>
            public short ParentIndex;

            /// <summary>
            /// Index of the first child in this FLVER3's bone collection, or -1 for none.
            /// </summary>
        ...
        public class VertexGroup
        {
            ...
            /// <summary>
            /// Index to a layout in the FLVER3's layout collection.
            /// </summary>
